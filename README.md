 ...
 * For best compatibility use together with HongFire patch [KK-HF_Patch](https://github.com/ManlyMarco/KK-HF_Patch) [KKS-HF_Patch](https://github.com/ManlyMarco/KKS-HF_Patch).
